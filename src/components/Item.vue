<template>
  <li class="item">
      ...
      <div v-if="editing" class="editor">
        <textarea v-model="whisper.content" placeholder="つぶやきを編集する" @keypress.enter="updateWhisper"></textarea>
        <p class="message">Press Enter to Whisper</p><!--/.message-->
        </div>
      <div v-else class="content" v-html="whisper.content"></div>
      <button v-if="currentUser && currentUser.uid == user.id" @click="showBtns = !showBtns"><fa icon="ellipsis-v" /></button>
